...
INSERT INTO `ib_item_templates` (`id`, `name`, `image`, `type`, `subtype`, `attr1`, `delay`, `particle`, `charimage`, `basevalue`) VALUES (143,'Quickdraw',150,'weapon','bow',2,0.80,'ARROW',0,55);
INSERT INTO `ib_item_templates` (`id`, `name`, `image`, `type`, `subtype`, `attr1`, `delay`, `particle`, `charimage`, `basevalue`) VALUES (144,'Pink Plinker',166,'weapon','bow',1,0.35,'ARROW',0,165);
...
INSERT INTO `ib_unit_templates` (`id`, `prefix`, `name`, `type`, `skin`, `eyes`, `hair`, `feet`, `body`, `head`, `friendly`, `health`, `armor`, `weapons`, `aimerror`, `loot`, `respawntime`, `displayweapon`, `size`, `aggroradius`, `spawnguardradius`, `special`, `param`, `disabled`, `weaponoffsetmultiplier`, `usebashattack`, `invisible`) VALUES (119,'a','Jimmy the Fence',21,1002,1003,1002,24,0,6,1,10,6,'64',1,'64;64;98;46;47;144;143',20,1,1.00,10,10,0,0,0,1.00,0,0);
...
CREATE TABLE `ib_units` (
  ...
  `data` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2207 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ib_units` (`id`, `x`, `y`, `z`, `zone`, `template`, `roty`, `param`, `data`) VALUES (2179,134.85,56.94,37.71,1,59,0.54,0,'null');
